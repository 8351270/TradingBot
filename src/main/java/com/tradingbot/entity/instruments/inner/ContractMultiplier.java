...
public class ContractMultiplier {
     ...
     * @param exponent
     */
    public ContractMultiplier(Long mantissa, Long exponent) {
        super();
    ...
    public ContractMultiplier withMantissa(Long mantissa) {
        this.mantissa = mantissa;
        return this;
    }
    ...
    public ContractMultiplier withExponent(Long exponent) {
        this.exponent = exponent;
        return this;
    }
